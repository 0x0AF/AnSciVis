...
Cube::Cube() : m_vao(0)
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(float) * 5 * cubeVertices.size(), cubeVertices.data(), GL_STATIC_DRAW);
...
Cube::Cube(glm::vec3 min, glm::vec3 max) : m_vao(0)
{
...
void Cube::freeVAO() { glDeleteVertexArrays(1, &m_vao); }
