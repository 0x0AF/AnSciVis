...
//            dst = vec4(normal, dst.a);
    ...
    while(inside_volume)
    {
        ...
        //        {
        //            i++;
        //            comp_color.r = comp_color.r * (1.0 - comp_transp) + color.a * color.r;
        //            comp_color.g = comp_color.g * (1.0 - comp_transp) + color.a * color.g;
        //            comp_color.b = comp_color.b * (1.0 - comp_transp) + color.a * color.b;
